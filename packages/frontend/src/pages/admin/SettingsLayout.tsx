...
import { Settings, Tags, Hash, CreditCard, Languages, ListPlus, type LucideIcon } from 'lucide-react';
import { Page } from '../../components/Page';
import { useAuth } from '../../auth/AuthContext';

export type SettingsSection = 'general' | 'labels' | 'terminology' | 'fields' | 'numbers' | 'billing';
