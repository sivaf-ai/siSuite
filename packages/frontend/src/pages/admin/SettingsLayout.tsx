...
import { Settings, Tags, Hash, CreditCard, Languages, type LucideIcon } from 'lucide-react';
import { Page } from '../../components/Page';
import { useAuth } from '../../auth/AuthContext';

export type SettingsSection = 'general' | 'labels' | 'terminology' | 'numbers' | 'billing';
