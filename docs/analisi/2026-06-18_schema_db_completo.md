# Schema DB completo — siSuite (al 18/06/2026)

> Rigenerato da `pg_dump --schema-only -n public` dopo le migrazioni **001→035** (max `035_filter_preset.sql`).
> Novità vs 17/06 (033): **034_export_preset** (preset export per-utente), **035_filter_preset** (set filtri salvati per-utente).
> Sostituisce `2026-06-17_schema_db_completo.md`. Rigenerare dopo nuove migrazioni.
...
\restrict WFEpBdRau9govNgkLbSP0Cwc0waRjZpucPHEuNCRffzJP7wsB7ZytLbEhv6903B
...
\unrestrict WFEpBdRau9govNgkLbSP0Cwc0waRjZpucPHEuNCRffzJP7wsB7ZytLbEhv6903B
