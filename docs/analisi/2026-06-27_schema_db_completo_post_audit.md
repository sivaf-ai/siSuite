# Schema DB completo — siSuite (post audit 01.06, al 27/06/2026)

> Rigenerato da `pg_dump --schema-only -n public` dopo le migrazioni **001->053**.
> Novità vs 051: **052** unit/weight_unit text -> unit_id/weight_unit_id FK unit_of_measure ON DELETE RESTRICT (11 colonne; vista job_cost_ledger ricreata; helper app_resolve_unit) · **053** unicità incl. righe di sistema (unit_of_measure/tax_rate parziali WHERE tenant_id IS NULL) + chiavi naturali (material_category, template, resource.code, app_user.code, numeri documento). Prossima migrazione libera: **054**.
...
\restrict jPPZhSrWlEziBQ0Yi0tEJ6hTChNWDm2aGB2O1Sm9ONT7Ze3Eb0X2blqUbJrMGDf
...
--
-- Name: saved_report saved_report_uq; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: work_order work_order_principal_ref_uk; Type: CONSTRAINT; Schema: public; Owner: -
--
...
CREATE UNIQUE INDEX purchase_order_tenant_number_uk ON public.purchase_order USING btree (tenant_id, number) WHERE (number IS NOT NULL);
...
\unrestrict jPPZhSrWlEziBQ0Yi0tEJ6hTChNWDm2aGB2O1Sm9ONT7Ze3Eb0X2blqUbJrMGDf
