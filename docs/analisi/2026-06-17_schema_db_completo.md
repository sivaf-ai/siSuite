# Schema DB completo — siSuite (al 17/06/2026)

> Rigenerato da `pg_dump --schema-only -n public` dopo le migrazioni **001→032** (max `032_work_order_generalize.sql`).
> Sostituisce `2026-06-16_schema_db_completo.md`. Rigenerare dopo nuove migrazioni.
...
\restrict c2WeJ56hb4ZHZKwR66c7Bdlr4XJicfFFytMSx0lwwuMXUDwfg7bqbTyk6ws67A6
...
\unrestrict c2WeJ56hb4ZHZKwR66c7Bdlr4XJicfFFytMSx0lwwuMXUDwfg7bqbTyk6ws67A6
